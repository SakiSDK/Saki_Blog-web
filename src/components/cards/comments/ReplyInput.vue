    ...
    >
        <div class="reply-item__header">
            <div class="reply-item__header-content">
                <Avatar :src="comment.user.avatar" :size="'40px'"/>
                <div 
                    class="reply-item__username"
                >
            ...
            <div class="reply-item-reply" @click="hanldeShowReplyInput">
                <Icon name="reply"/>
                <span>回复</span>
            </div>
        </div>
...
.reply-item {
    ...
    &__header {
        ...
        @include mix.border-d(b, var(--border-base));
